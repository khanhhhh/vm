...
int main() {
	...
	uint8_t code[] = {
		// int main()
		0x01, 0x00, 0x00, 0x00, 0x00,	// load code 0			#0
		0x1d,				// push_fp			#5
		...
		0x19, 0x28, 0x00, 0x00, 0x00,	// ifgt_jump B1			#29
			...
			0x01, 0x00, 0x00, 0x00, 0x00,	// load code 0 (B1)	#40
			0x1d,				// push_fp		#45
			0x03, 0x00, 0x00, 0x00, 0x00,	// load stack 0		#46
			0x01, 0x01, 0x00, 0x00, 0x00,	// load code 1		#51
			0x0b,				// isub			#56
			0x1e, 0x00, 0x00, 0x00, 0x00,   // call_fp `fib`	#57

	                0x01, 0x00, 0x00, 0x00, 0x00,   // load code 0 (B1)	#62
        	        0x1d,                           // push_fp		#67
                	0x03, 0x00, 0x00, 0x00, 0x00,   // load stack 0		#68
			0x01, 0x02, 0x00, 0x00, 0x00,	// load code 2		#73
			0x0b,				// isub			#78
			0x1e, 0x00, 0x00, 0x00, 0x00,	// call_fp `fib`	#79
			0x09,				// iadd			#84
			0x20,				// return1		#85
	};
